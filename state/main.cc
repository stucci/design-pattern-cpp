// https : // refactoring.guru/design-patterns/state/cpp/example#lang-features
#include <iostream>
#include <string>
#include <typeinfo>
...
public:
  ...
  void Handle2() override { cout << "ConcreteStateA handles request2.\n"; }
};

class ConcreteStateB : public State {
public:
  void Handle1() override { cout << "ConcreteStateB handles request1.\n"; }
